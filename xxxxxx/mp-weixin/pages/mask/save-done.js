(global["webpackJsonp"] = global["webpackJsonp"] || []).push([
  ["pages/mask/save-done"], {
      ...
      (function (t) {
        ...
        var r = function () {
          ...
          f = {
            ...
            onLoad: function (t) {
              this.windowHeight = getApp().globalData.windowHeight, getApp().globalData.userAvatarFilePath && (this.avatarPath = getApp().globalData.userAvatarFilePath), wx.createInterstitialAd && (h = wx.createInterstitialAd({
                adUnitId: "adunit-2bf7cf186785bfda"
              }), h.onLoad((function () {})), h.onError((function (t) {
                console.log(t)
              })), h.onClose((function () {})));
              var e = this;
              wx.createRewardedVideoAd && (l = wx.createRewardedVideoAd({
                adUnitId: "adunit-9a8af70b40e15f29"
              }), l.onLoad((function () {
                e.rewardedVideoAdLoaded = !0
              })), l.onError((function (t) {
                e.rewardedVideoAdLoaded = !1
              })), l.onClose((function (t) {
                t && t.isEnded || void 0 === t ? e.rewardedVideoAdAlreadyShow = !0 : e.rewardedVideoAdAlreadyShow = !1
              })))
            },
            onReady: function () {
            ...
            onShow: function () {
              console.log("onShow"), getApp().globalData.rapaintAfterCrop && (getApp().globalData.rapaintAfterCrop = !1, this.avatarPath = getApp().globalData.cropImageFilePath, this.paint()), h && h.show().catch((function (t) {
                console.error(t)
              }))
            },
            ...
            methods: i(i({}, (0, n.mapMutations)(["saveLoginUserInfo"])), {}, {
              paint: function () {},
              showTips: function () {
              ...
              touchMove: function (t) {
                ...
                if ("mask" == this.touch_target && (this.maskCenterX = this.maskCenterX + n, this.maskCenterY = this.maskCenterY + o, this.cancelCenterX = this.cancelCenterX + n, this.cancelCenterY = this.cancelCenterY + o, this.handleCenterX = this.handleCenterX + n, this.handleCenterY = this.handleCenterY + o), "handle" == this.touch_target) {
                  ...
                  var i = this.handle_center_x - this.mask_center_x,
                    s = this.handle_center_y - this.mask_center_y,
                    r = this.handleCenterX - this.mask_center_x,
                    c = this.handleCenterY - this.mask_center_y,
                    l = Math.sqrt(i * i + s * s),
                    h = Math.sqrt(r * r + c * c),
                    d = Math.atan2(s, i) / Math.PI * 180,
                ...
                t.getImageInfo({
                  ...
                  success: function (n) {
                    var o = n.width,
                      i = n.height,
                      s = (o - i) / o.toFixed(3);
                    if (console.log("delta", s), -.02 <= s && s <= 0 || 0 < s && s <= .02) {
              ...
              draw: function () {
                var e = this.scale,
                  ...
                  i = this,
                  s = wx.createSelectorQuery();
                s.select("#avatar-bg").boundingClientRect(), s.exec((function (s) {
                  n -= s[0].left, o -= s[0].top;
                  var r = wx.createCanvasContext("cans-id-mask"),
                    c = (wx.getSystemInfoSync().windowWidth, 100 * e);
                  r.clearRect(0, 0, i.cansWidth, i.cansHeight), r.drawImage(i.avatarPath, 0, 0, i.cansWidth, i.cansHeight), r.translate(n, o), r.rotate(a * Math.PI / 180), i.isAndroid && 180 == i.rotateY && r.scale(-1, 1), r.drawImage(i.maskPic, -c / 2, -c / 2, c, c), r.draw(), i.saveCans(), l && i.rewardedVideoAdLoaded && t.showModal({
                    title: "获取无限使用次数",
                    content: "请完整观看趣味广告视频，更多个性化口罩护目镜任意添加",
                    success: function (t) {
                      if (t.confirm) console.log("用户点击确定"), l && (i.rewardedVideoAdAlreadyShow = !0, l.show().catch((function () {
                      ...
                      else if (t.cancel) return void console.log("用户点击取消")
                    }
                  })
                }))
              },
                  ...
                  success: function (a) {
                    t.hideLoading(), getApp().globalData.maskAvatarSavedTempPath = a.tempFilePath, t.saveImageToPhotosAlbum({
                      ...
                      success: function (a) {
                        ...
                        }), h && e.enableInterstitialAd && !e.interstitialAdAlreadyShow && !e.rewardedVideoAdAlreadyShow && h.show().then((function () {
                          e.interstitialAdAlreadyShow = !0
                        })).catch((function (t) {
                          h.load().then((function () {
                            h.show()
                          })).catch((function (t) {
                            console.log(t), console.log("插屏广告显示失败")
                          })), console.error(t)
                        })), console.log("保存成功")
                      },
                      fail: function (e) {
    ...
    "8ba2": function (t, e, a) {
      ...
      a("2949");
      var s, r = a("f0c5"),
        c = Object(r["a"])(o["default"], n["b"], n["c"], !1, null, "0565f7cd", null, !1, n["a"], s);
      e["default"] = c.exports
    },
    a30a: function (t, e, a) {
      "use strict";
  ...
  [
    ["a30a", "common/runtime", "common/vendor"]
  ]
]);